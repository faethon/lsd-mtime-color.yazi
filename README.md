...
require("lsd-mtime-color"):setup({
  ...
  color_hour      = "#00d700",         -- color for < 1 hour
  color_day       = "#00d787",         -- color for < 1 day
  color_month     = "#00af87",         -- color for < 30 days
  color_older     = "#00875f",         -- color for older
  ...
  color_none      = "#6c6c6c",         -- color for size 0
  color_small     = "#ffffaf",         -- color for size small
  color_medium    = "#ffd787",         -- color for size medium 
  color_large     = "#ffaf5f",         -- color for size large
  color_huge      = "#ff8700",         -- color for size huge
